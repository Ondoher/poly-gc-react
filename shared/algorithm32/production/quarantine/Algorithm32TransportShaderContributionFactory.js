...
/**
 * Provide the core Algorithm32 transport shader contribution for a descriptor.
 */
export class Algorithm32TransportShaderContributionFactory {
	/**
...
export default Algorithm32TransportShaderContributionFactory;
