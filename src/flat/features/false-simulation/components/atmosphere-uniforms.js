...
function sunUniformValues(sun) {
	return {
		...
		sunDirection: vectorArray(sun?.direction),
		sunPosition: vectorArray(sun?.position),
...
/**
 * Create atmosphere uniforms for the false-simulation renderer.
 *
 * @param {FalseSimulationAtmosphereSettings | null | undefined} atmosphereSettings - Provide scene atmosphere settings.
 * @param {FlatSunLightState | FlatSunState | null | undefined} resolvedSunLight - Provide the resolved animated sun light.
 * @returns {FalseSimulationAtmosphereUniformAdapter}
 */
