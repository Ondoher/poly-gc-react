...
import {
	...
	DEFAULT_FALSE_SIMULATION_OBJECTS,
...
/**
 * Create plain false-simulation scene view models from projection, catalog,
...
export default class FalseSimulationSceneModel {
	 ...
	 *
	 * @param {Partial<FalseSimulationConfig>} config - Override default scene assumptions.
	 */
	constructor(config = {}) {
		/**
		 ...
		 *
		 * @type {FalseSimulationSourceObject[]}
		 */
		 ...
		 *
		 * @type {FalseSimulationSunConfig | null}
		 */
	 ...
	 *
	 * @param {Partial<FalseSimulationSunConfig>} sun - Override false-sun assumptions.
	 * @returns {FalseSimulationSunConfig}
	 */
	mergeSunConfig(sun = {}) {
		return {
			...DEFAULT_FALSE_SIMULATION_SUN,
			...sun,
			style: {
				...DEFAULT_FALSE_SIMULATION_SUN.style,
				...(sun.style || {}),
			},
			rendering: {
				...DEFAULT_FALSE_SIMULATION_SUN.rendering,
				...(sun.rendering || {}),
			},
			light: {
				...DEFAULT_FALSE_SIMULATION_SUN.light,
				...(sun.light || {}),
				color: {
					...DEFAULT_FALSE_SIMULATION_SUN.light.color,
					...(sun.light?.color || {}),
				},
				anchor: {
					...DEFAULT_FALSE_SIMULATION_SUN.light.anchor,
					...(sun.light?.anchor || {}),
				},
			},
			animation: {
				...DEFAULT_FALSE_SIMULATION_SUN.animation,
				...(sun.animation || {}),
			},
		};
	}
	 ...
	 *
	 * @param {FalseSimulationProjectedStar[]} projectedStars - Provide projected stars keyed by name.
	 * @returns {FalseSimulationProjectedConstellation[]}
	 */
	 ...
	 * @param {ProjectionModel} projectionModel - Provide the active projection model.
	 * @param {FlatVector3} observerPosition - Provide the projected observer position.
	 * @returns {FalseSimulationProjectedObject[]}
	 */
