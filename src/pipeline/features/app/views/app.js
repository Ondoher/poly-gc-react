...
export default class AppView extends Service {
	constructor(registry) {
		...
		this.implement(['ready', 'getComponent', 'getShellState', 'requestPage', 'requestTileset']);
	}
	...
	ready() {
		...
		this.controller.listen('tilesets-updated', (details) => this.fire('tilesets-updated', details));
	}
	...
	requestTileset(tilesetId) {
		return this.controller.requestTileset(tilesetId);
	}
}
