/**
 * Define the service contract for the reference approval page view.
 */
interface ReferenceApprovalViewService {
	/**
	 * Return the reference approval presentation component.
	 */
	getComponent(): import('react').ReactElement;

	/**
	 * Return the current page state with derived summary.
	 */
