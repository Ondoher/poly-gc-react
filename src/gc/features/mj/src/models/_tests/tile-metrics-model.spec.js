...
import TileMetricsModel, { LAYOUT_METRIC_CSS_VAR_NAMES } from "../tile-metrics-model.js";

describe("TileMetricsModel", function() {
	...
	function makeService(metricSetsById = null, options = {}) {
		let service = new TileMetricsModel(new Registry());
		service.start();
	...
	describe("Lifecycle", function() {
		it("should subscribe to the css-vars service during ready", function() {
			...
			let service = new TileMetricsModel(registry);
			service.start();
			service.ready();
