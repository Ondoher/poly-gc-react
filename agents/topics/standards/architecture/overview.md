...
- [REMVC](/c:/dev/poly-gc-react/agents/topics/standards/architecture/remvc.md)
...
- [Registry](/c:/dev/poly-gc-react/agents/topics/standards/architecture/remvc.md#registry)
- [Model And Service Boundary](/c:/dev/poly-gc-react/agents/topics/standards/architecture/remvc.md#model-and-service-boundary)
...
- [Feature Ownership And Structure](/c:/dev/poly-gc-react/agents/topics/standards/architecture/feature-mechanics.md#feature-ownership-and-structure)
- [Naming And Placement Conventions](/c:/dev/poly-gc-react/agents/topics/standards/architecture/feature-mechanics.md#naming-and-placement-conventions)
...
- [Randomness](/c:/dev/poly-gc-react/agents/topics/standards/architecture/randomness.md)
