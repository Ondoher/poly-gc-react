...
This note should be read together with [build-and-assets.md](/c:/dev/poly-gc-react/agents/topics/standards/architecture/build-and-assets.md):
...
The broader application architecture is documented separately in [remvc.md](/c:/dev/poly-gc-react/agents/topics/standards/architecture/remvc.md).
...
- class implementation files should export only the class they implement; data
  constants belong in a nearby `consts.js`, and reusable stateless functions
  belong in a focused utility/helper module
...
- [Scripts Standard](/c:/dev/poly-gc-react/agents/topics/standards/scripts/README.md)
...
- if CSS or image assets need to be copied into `dist`, follow the placement rules in [build-and-assets.md](/c:/dev/poly-gc-react/agents/topics/standards/architecture/build-and-assets.md)
- if runtime asset path questions arise, use [build-and-assets.md](/c:/dev/poly-gc-react/agents/topics/standards/architecture/build-and-assets.md) as the source of truth
...
[React Code](/c:/dev/poly-gc-react/agents/topics/standards/react-code/README.md).
...
The complementary build-side questions are covered in [build-and-assets.md](/c:/dev/poly-gc-react/agents/topics/standards/architecture/build-and-assets.md):
