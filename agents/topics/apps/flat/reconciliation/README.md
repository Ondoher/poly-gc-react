...
- The immediate continuation task is Milestone 4.3.2: recreate the required
  ...
  [Local Sun Flat Geometry Fact Inventory](local-sun-flat-geometry-fact-inventory.md),
  [Unsourced And Partially Sourced Facts](unsourced-and-partially-sourced-facts.md),
  [M2 Calibration And Evidence Plan](m2-calibration-and-evidence-plan.md),
  then read `scripts/flat/reconciliation/POC/CURRENT_STATE.md` for the
  mutable POC state. Milestone 2 is closed in record
