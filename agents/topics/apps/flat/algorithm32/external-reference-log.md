# Algorithm32 External Reference Log

Imported from the retired atmosphere reset reference lane as a source-mining
catalog for production Algorithm32. Use this file to locate external sources,
source-backed constants, fixture rationale, and validation expectations. Do
not treat predecessor implementation paths or stage names in this document as
current production ownership.

## Original Title: Reference Decision Log
...
- Reflected in [Fixture Sources](fixture-sources.md) as a ready conventional
...
- Reflected in [Test Design](test_design.md), [Plan](plan.md), and
  [Fixture Sources](fixture-sources.md).
...
- ASTM G-173 wavelength-grid rows use the NLR/NREL data-table provenance:
  ...
  inspected local checksums recorded in [Fixture Sources](fixture-sources.md).
...
- [Reference Decision Log](external-reference-log.md#expectation-fixturesspecjs-validation-source-map)
...
- [Reference Decision Log](external-reference-log.md#expected-value-intake-workflow)
