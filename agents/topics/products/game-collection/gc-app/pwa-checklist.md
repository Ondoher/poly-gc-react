...
- use [MVP Implementation Checklist](/c:/dev/poly-gc-react/agents/topics/archive/mvp-summary.md) to track the first-release coding work for manifest, icons, HTML integration, and other MVP PWA tasks
