...
- [Solving_Mahjong_Solitaire_boards_with_peeking.pdf](../../../../../../references/game-collection/mahjongg-solitaire/difficulty/research/Solving_Mahjong_Solitaire_boards_with_peeking.pdf)

The PDF lives in the repo-level references area so active topic docs do not
carry large research source files.
