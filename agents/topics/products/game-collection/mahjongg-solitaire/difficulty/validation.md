...
- use [MVP Implementation Checklist](/c:/dev/poly-gc-react/agents/topics/archive/mvp-summary.md) to track first-release coding work for consent, feedback, telemetry transport, and related launch integration
