...
- [Tile Size Scaling](/c:/dev/poly-gc-react/agents/topics/mj/tile-size-scaling.md)
...
- tile-size removal and layout-bound fit plan: [tile-size-scaling.md](/c:/dev/poly-gc-react/agents/topics/mj/tile-size-scaling.md)
