...
- [MJ HTML And CSS Refactor](/c:/dev/poly-gc-react/agents/topics/mj/html-css-refactor.md)
...
- tile-size removal and layout-bound fit plan: [scaling topic index](/c:/dev/poly-gc-react/agents/topics/scaling/README.md)
- current MJ layout refactor direction: [html-css-refactor.md](/c:/dev/poly-gc-react/agents/topics/mj/html-css-refactor.md)
...
- preview sizing and rendering direction: [settings-preview-area.md](/c:/dev/poly-gc-react/agents/topics/scaling/settings-preview-area.md)
